...
namespace Object::Impl::Brdf {
    ...
    Math::Vector OrenNayar::sample(Math::Sampler &sampler, const Math::Normal &nrm, const Math::Vector &) const
    {
    ...
    Math::Pdf OrenNayar::pdf(const Math::Vector &dirIn, const Math::Normal &nrm, const Math::Vector &) const
    {
