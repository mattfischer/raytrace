    ...
    pub fn new(width: usize, height: usize, control_points: [Point3; 16]) -> BezierPatch {
        ...
        for j in 0..height {
            for i in 0..width {
                ...
                let s1 =
                    ((if i < width / 2 { i + 1 } else { i - 1 }) as f32) / ((width - 1) as f32);
                let t1 =
                    ((if j < height / 2 { j + 1 } else { j - 1 }) as f32) / ((height - 1) as f32);
                ...
                let bds = [
                    -3.0 * (1.0 - s).powi(2),
                    3.0 * (1.0 - s).powi(2) - 3.0 * 2.0 * s * (1.0 - s),
                    3.0 * 2.0 * s * (1.0 - s) - 3.0 * s.powi(2),
                    3.0 * s.powi(2),
                ];
                let bdt = [
                    -3.0 * (1.0 - t).powi(2),
                    3.0 * (1.0 - t).powi(2) - 3.0 * 2.0 * t * (1.0 - t),
                    3.0 * 2.0 * t * (1.0 - t) - 3.0 * t.powi(2),
                    3.0 * t.powi(2),
                ];

                let bs1 = [
                    (1.0 - s1).powi(3),
                    3.0 * s1 * (1.0 - s1).powi(2),
                    3.0 * s1.powi(2) * (1.0 - s1),
                    s1.powi(3),
                ];
                let bt1 = [
                    (1.0 - t1).powi(3),
                    3.0 * t1 * (1.0 - t1).powi(2),
                    3.0 * t1.powi(2) * (1.0 - t1),
                    t1.powi(3),
                ];
                let bds1 = [
                    -3.0 * (1.0 - s1).powi(2),
                    3.0 * (1.0 - s1).powi(2) - 3.0 * 2.0 * s1 * (1.0 - s1),
                    3.0 * 2.0 * s1 * (1.0 - s1) - 3.0 * s1.powi(2),
                    3.0 * s1.powi(2),
                ];
                let bdt1 = [
                    -3.0 * (1.0 - t1).powi(2),
                    3.0 * (1.0 - t1).powi(2) - 3.0 * 2.0 * t1 * (1.0 - t1),
                    3.0 * 2.0 * t1 * (1.0 - t1) - 3.0 * t1.powi(2),
                    3.0 * t1.powi(2),
                ];
